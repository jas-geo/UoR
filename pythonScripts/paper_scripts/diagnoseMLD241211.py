...
# ax.plot(time2,damarell_sst, color='deeppink',linestyle='solid',label = r'Damarell_2020')
...
# plt.show()
# plt.savefig("compare_SST_Fig.8_paper_damarell_os_241211.png")
...
ax[0].plot(time2,np.negative(damarell_mld), color='deeppink',linestyle='solid',label = r'Damarell_2020')
...
plt.show()
# plt.savefig('compare_MLDs_Fig.6_paper_damarell_os_241211.png')
plt.savefig('compare_MLDs_Fig.7_paper_damarell_os_241211.png')
