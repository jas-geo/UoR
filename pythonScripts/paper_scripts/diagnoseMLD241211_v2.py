...
# # # # # # # # # # # # # # # #
#                             #
# DAMARELL ET AL (2020) Data  #
#                             #
# # # # # # # # # # # # # # # # 

### 

damarell_osmosis_model = xr.open_dataset("osmosis_model_forMT.nc")
damarell_mld = damarell_osmosis_model.mld
damarell_sst = damarell_osmosis_model.sst
damarell_osmosis_model['time'] = damarell_osmosis_model['time'].astype('float64')
damarell_time = damarell_osmosis_model.time.values

damarell_time2 = 267.75 + (damarell_time[:]/86400);#

damarell_osmosis_model = damarell_osmosis_model.assign(damarell_time2=("time", damarell_time2)); 
damarell_osmosis_model = damarell_osmosis_model.swap_dims({"time" : "damarell_time2"})

print("STOP: time (Damarell et al (2020) ",damarell_time)
print("STOP: mld (Damarell et al (2020)",damarell_mld)


# plt.plot(time2,np.negative(damarell_mld), color='deeppink',linestyle='solid',label = r'Damarell_2020')
# plt.grid()
# plt.savefig('osmosis_model_241210.png')
...
# SST
ax.plot(new_time,GldrTemp,color='indigo',linestyle='dashed',label ='OSMOSIS data')
ax.plot(time2,damarell_sst, color='deeppink',linestyle='solid',label = r'OSMOSIS model')
...
plt.show()
plt.savefig("compare_SST_Fig.8_paper_damerell_os_241211.png")
...
# ax[0].plot(df_dats5,np.negative(df_mld5), color='indigo',linestyle='dashed',label = r'OSMOSIS data')
# ax[0].plot(time2,np.negative(damarell_mld), color='deeppink',linestyle='solid',label = r'OSMOSIS model')
...
# ax[1].plot(time2,np.negative(damarell_mld), color='deeppink',linestyle='solid',label = '_nolegend_')
...
# ax[2].plot(time2,np.negative(damarell_mld), color='deeppink',linestyle='solid',label = '_nolegend_')
...
# plt.show()
# plt.savefig('compare_MLDs_Fig.6_paper_damerell_os_241211.png')
# # plt.savefig('compare_MLDs_Fig.7_paper_damerell_os_241211.png')
