...
# print('Glider time from 2012-09-22',new_time[194:938].values) 560:645
...
# print('glider time = 301', new_time[560:645])
# gliderTemp277 = np.c_[GldrDepth[0:200],GldrTemp[560,0:200]], 
# print('glider temp values at time = 301',gliderTemp277);
# gliderSalt277 = np.c_[GldrDepth[0:200],GldrSalt[560,0:200]], 
# print('glider temp values at time = 301',gliderSalt277)

# gliderTemp_Depth0 = np.c_[np.arange(560,643),GldrTemp[560:643,0]]
# print('Glider depth', GldrDepth[0].values)
# print('Glider temp for depth=-1', GldrTemp[560:643,0].values)
# print('Glider temp for depth=-1', gliderTemp_Depth0)
# print(np.nanmin(GldrTemp[560:643,0].values),np.nanmax(GldrTemp[560:643,0].values),np.nanmedian(GldrTemp[560:643,0].values),len(GldrTemp[560:643,0].values))

# gliderTemp_Depth0 = gliderTemp_Depth0[np.argsort(gliderTemp_Depth0[:, 1])]
# print(gliderTemp_Depth0)

# arr = np.array([638,636,634,625,622,614,608,603,597,572,575,568,595,592,588,587])
# arr = np.array([638,634,622,608,597,575,595,588])
# arr = arr[np.argsort(arr)]; # print(arr)

### ----------------------------- GOTM ----------------------------- ###

# with (PAP-SO)
gotmkpp = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_comparison_PAP.nc", decode_times=False)
gotmkppLoc = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_comparisonLoc_PAP.nc", decode_times=False)
gotmkeps = xr.open_dataset("autumn_lowLatkeps/OSMOSIS_cruise_winter.nc", decode_times=False)
# changed the definition of eddy viscosity (num(k)) in kpp.F90
gotmkppLa = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newEddyVisc_PAP.nc", decode_times=False)
# changed the definition of eddy viscosity (num(k)) in kpp.F90 wihtout non-local fluxes
gotmkppLaLoc = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newEddyViscLoc_PAP.nc", decode_times=False)
gotmkppLag05 = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newEddyVisc_0.5_PAP.nc", decode_times=False)
gotmkppLag2 = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newEddyVisc_2_PAP.nc", decode_times=False)
gotmkppLa05dlta = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newEddyVisc_0.5dlta_PAP.nc", decode_times=False)
gotmkppLa025dlta = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newEddyVisc_0.25dlta_PAP.nc", decode_times=False)
gotmkppLa125dlta = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newEddyVisc_0.125dlta_PAP.nc", decode_times=False)
gotmkppLa0625dlta = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newEddyVisc_0.0625dlta_PAP.nc", decode_times=False)
# changed the definition of heat diffusivity (nuh(k)) in kpp.F90
gotmkpp_heat = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newHeatDiff_PAP.nc", decode_times=False)
# changed the definition of heat diffusivity (nuh(k)) in kpp.F90 without non-local fluxes
gotmkpp_heatLoc = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newHeatDiffLoc_PAP.nc", decode_times=False)
gotmkpp_heatg05 = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newHeatDiff_0.5_PAP.nc", decode_times=False)
gotmkpp_heatg2 = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newHeatDiff_2_PAP.nc", decode_times=False)
gotmkpp_heat05dlta = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newHeatDiff_0.5dlta_PAP.nc", decode_times=False)
gotmkpp_heat025dlta = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newHeatDiff_0.25dlta_PAP.nc", decode_times=False)
gotmkpp_heat125dlta = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newHeatDiff_0.125dlta_PAP.nc", decode_times=False)
gotmkpp_heat0625dlta = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newHeatDiff_0.0625dlta_PAP.nc", decode_times=False)
# changed the definition of heat diffusitivity (nuh(k)) in kpp.F90 ##
gotmkpp_m_h = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_new_ViscDiff_PAP.nc", decode_times=False)
gotmkpp_m_hLoc = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_new_ViscDiffLoc_PAP.nc", decode_times=False)
gotmkpp_m_hg05 = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newViscDiff_0.5_PAP.nc", decode_times=False)
gotmkpp_m_hg2 = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newViscDiff_2_PAP.nc", decode_times=False)
gotmkpp_m_h05dlta = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newViscDiff_0.5dlta_PAP.nc", decode_times=False)
gotmkpp_m_h025dlta = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newViscDiff_0.25dlta_PAP.nc", decode_times=False)
gotmkpp_m_h125dlta = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newViscDiff_0.125dlta_PAP.nc", decode_times=False)
gotmkpp_m_h0625dlta = xr.open_dataset("../../../gotm-4.0.0-edit/simulations/autumn_lowLatKPP/OSMOSIS_newViscDiff_0.0625dlta_PAP.nc", decode_times=False)
...
## Convert time
time2 = 301.875 + (time[:]/86400); ketime2 = 301.875 + (ketime[:]/86400)
time2Loc = 301.875 + (timeLoc[:]/86400); 
time2La = 301.875 + (timeLa[:]/86400); time2LaLoc = 301.875 + (timeLaLoc[:]/86400); time2Lag05 = 301.875 + (timeLag05[:]/86400);  time2Lag2 = 301.875 + (timeLag2[:]/86400);  time2La05dlta = 301.875 + (timeLa05dlta[:]/86400);  time2La025dlta = 301.875 + (timeLa025dlta[:]/86400); time2La125dlta = 301.875 + (timeLa125dlta[:]/86400); time2La0625dlta = 301.875 + (timeLa0625dlta[:]/86400); 
time2_heat = 301.875 + (time_heat[:]/86400); time2_heatLoc = 301.875 + (time_heatLoc[:]/86400); time2_heatg05 = 301.875 + (time_heatg05[:]/86400); time2_heatg2 = 301.875 + (time_heatg2[:]/86400); time2_heat05dlta = 301.875 + (time_heat05dlta[:]/86400); time2_heat025dlta = 301.875 + (time_heat025dlta[:]/86400); time2_heat125dlta = 301.875 + (time_heat125dlta[:]/86400); time2_heat0625dlta = 301.875 + (time_heat0625dlta[:]/86400);
time2_mh = 301.875 + (time_mh[:]/86400); time2_mhLoc = 301.875 + (time_mhLoc[:]/86400);time2_mhg05 = 301.875 + (time_mhg05[:]/86400); time2_mhg2 = 301.875 + (time_mhg2[:]/86400); time2_mh05dlta = 301.875 + (time_heat05dlta[:]/86400); time2_mh025dlta = 301.875 + (time_mh025dlta[:]/86400); time2_mh125dlta = 301.875 + (time_mh125dlta[:]/86400); time2_mh0625dlta = 301.875 + (time_mh0625dlta[:]/86400);
...
# print('GOTM time from low values Lat v1',time2.values, time2.shape)
# print('Glider time from low values Lat',new_time[560:645], new_time.shape)

# GliderTimeIndex = np.c_[np.arange(560,645),new_time[560:645]]
# print('2D GLider time with index', GliderTimeIndex)
GTMTimeIndex = np.c_[np.arange(0,1242),time2.values]
...
# ## using KPP EV 16*dlta model
# mld_tempKPPLa0625dlta = GTMtempLa0625dlta.sel(z=-11.0, method='nearest') - 0.2; 
# # z_indexes = abs(GTMtemp - mld_temp).z#.load()
# z_indexes = abs(GTMtempLa0625dlta-mld_tempKPPLa0625dlta).argmin('z'); # print(z_indexes)
# mldKPPLa0625dlta = GTMtempLa0625dlta.z[z_indexes]; 
# mldKPPLa0625dlta = mldKPPLa0625dlta.isel(lat=0,lon=0); # print('mixed layer depth :',mld, mld.shape)

# ## using KPP HD 16*dlta model
# mld_tempKPPheat0625dlta = GTMtemp_heat0625dlta.sel(z=-11.0, method='nearest') - 0.2; 
# # z_indexes = abs(GTMtemp - mld_temp).z#.load()
# z_indexes = abs(GTMtemp_heat0625dlta-mld_tempKPPheat0625dlta).argmin('z'); # print(z_indexes)
# mldKPPheat0625dlta = GTMtemp_heat0625dlta.z[z_indexes]; 
# mldKPPheat0625dlta = mldKPPheat0625dlta.isel(lat=0,lon=0); # print('mixed layer depth :',mld, mld.shape)

# ## using KPP EV-HD 16*dlta model
# mld_tempKPPmh0625dlta = GTMtemp_mh0625dlta.sel(z=-11.0, method='nearest') - 0.2; 
# # z_indexes = abs(GTMtemp - mld_temp).z#.load()
# z_indexes = abs(GTMtemp_mh0625dlta-mld_tempKPPmh0625dlta).argmin('z'); # print(z_indexes)
# mldKPPmh0625dlta = GTMtemp_mh0625dlta.z[z_indexes]; 
# mldKPPmh0625dlta = mldKPPmh0625dlta.isel(lat=0,lon=0); # print('mixed layer depth :',mld, mld.shape)
...
# plt.plot(time2La0625dlta,mldKPPLa0625dlta,color='steelblue',linestyle=(0, (3, 1, 1, 1, 1, 1)),label = 'GOTM KPP EV 16*dlt');
# plt.plot(time2_heat0625dlta,mldKPPheat0625dlta,color='firebrick',linestyle=(0, (3, 1, 1, 1, 1, 1)),label = 'GOTM KPP HD 16*dlt');
# plt.plot(time_mh0625dlta,mldKPPmh0625dlta,color='darkorchid',linestyle=(0, (3, 1, 1, 1, 1, 1)),label = 'GOTM KPP EV-HD 16*dlt');
...
# plt.axis([301.875,310.5,-150,0]);# plt.title('Compare OSMOSIS & GOTM-KPP,-k-epsilon MLDs')
...
# a = np.arange(560,645,10) 
# b = np.arange(0,621,100)
# ## -------------------------- Glider -------------------------- ##
# #choose the indices for each day
# a = [568,572,575,587,588,592,595,597,603,608,614,622,625,634,636,638]
# a = [575,588,595,597,608,622,634,638]
# a = [563, 570, 579, 589, 599, 609, 619, 629, 639]
# for i in a:
# 	Gldrtemp1d = GldrTemp.isel()[i,:]; Gldrdepth = GldrDepth[:]
# 	Gldrtime = new_time[i] 
# 	plt.plot(Gldrtemp1d,Gldrdepth,label='Glider Day %s'%Gldrtime.values); 
# 	# plt.legend(loc=(0.55,0.05),fontsize ='x-small')
# 	plt.legend(loc='best',fontsize ='small')
# 	plt.xlabel('Temperature -C');plt.ylabel('Depth -m'); 
# 	plt.title('Glider Temperature Profiles for Autumn low La_t values')
# 	plt.axis([11,18,-150,0])
# plt.savefig('Glider_Temp_profile_lowLat_v1.png')
# plt.show()

# ## -------------------------- k-eps -------------------------- ##
# #choose the indices for each day
# b = [8, 80, 152, 224, 296, 368, 440, 512, 584]
...
# 	plt.legend(loc='best',fontsize ='small')
# 	plt.xlabel('Temperature -C');plt.ylabel('Depth -m'); 
# 	plt.title('GOTM k-epsilon Temperature profiles for Autumn low La_t values')
# 	plt.axis([11,18,-150,0])
# plt.savefig('GOTM_keps_Temp_profile_lowLat_v1.png')
# plt.show()
...
# 	plt.legend(loc='best',fontsize ='small')
# 	plt.xlabel('Temperature -C');plt.ylabel('Depth -m'); 
# 	plt.title('GOTM KPP Temperature profiles for low La_t values')
# 	plt.axis([11,18,-150,0])
# plt.savefig('GOTM_kpp_Temp_profile_lowLat_v1.png')
# plt.show()
...
# plt.savefig('osmosis_autumn_variablePlots/GOTM_streamwise_velocity_timeseries_AutumnlowLat.png')
# plt.show()
...
# 	# plt.axis([11.0,15.5,-150,0])
# plt.savefig('osmosis_autumn_variablePlots/GOTM_spanwise_velocity_timeseries_AutumnlowLat.png')
# plt.show()

## -------------------------- Comparisons ------------------------------ ##
# select desired rows for the loop to plot day after change in wave direction
# print('Glider time from low values values Lat',new_time[560:645])
# print('GOTM low values Lat wind change 1',time2[116])
# print('Glider low values Lat wind change 1',new_time[574])
# print('GOTM low values Lat wind change 2',time2[530])
# print('Glider low values Lat wind change 2',new_time[631])

GTM_sel = [0] # range [f:m:l] = [0:377:1241]
Gldr_sel = [560] # range [f:m:l] = [560:584:643]
...
for j in Gldr_sel:
	...
	# plt.plot(kpptempLa,k,color='steelblue',linestyle='solid',label = 'KPP EV d=%0.2f'%kpptimeLa.values); plt.legend(loc='best', fontsize='small')
	...
	plt.axis([11,18,-150,0])
	# plt.ylim(-150,0)
plt.savefig('osmosis_autumn_variablePlots/Gldr_GOTM_Temperature_profile_Aut_lowLat.png')
plt.show()
exit()
# for i in GTM_sel:
# 	kpptemp1d = GTMtemp.isel(lon=0,lat=0)[i,:]; kppdepth = GTMdepth[:]
...
plt.ylim(-150,0)
plt.savefig('autumn_lowLatKPP/GOTM_kpp_kpploc_kppvisc_kppheat_kppmh_keps_eddy_viscosity_profile.png')
plt.show()
...
# plt.axis([-0.01,0.15,-100,0])
plt.ylim(-150,0)
plt.savefig('autumn_lowLatKPP/GOTM_kpp_kpploc_kppLa_kppheat_kppmh_keps_heat_diffusivity_profile.png')
plt.show()
...
# plt.axis([-0.01,0.15,-100,0])
plt.ylim(-150,0)
plt.savefig('autumn_lowLatKPP/GOTM_kpp_kppLa_kppheat_kppmh_keps_streamwise_velocity_profile.png')
plt.show()
...
# plt.axis([-0.01,0.15,-100,0])
plt.ylim(-150,0)
plt.savefig('autumn_lowLatKPP/GOTM_kpp_kppLa_kppheat_kppmh_keps_spanwise_velocity_profile.png')
plt.show()
...
for j in Gldr_sel:
	...
	# plt.plot(kpptempLoc,kppdepthLoc,'k--',label = 'GOTM_KPP local Day %s'%kpptimeLoc.values); plt.legend(loc='best', fontsize='small')
	...
	# plt.title('Compared Temperature Profiles : Glider and GOTM w KPP,k-eps')
	plt.axis([11,18,-150,0])
plt.savefig('autumn_lowLatKPP/Gldr_GOTM_kpp_kpploc_kppvisc_kppheat_kppmh_keps_Temp_profile_lowLat_test.png')
plt.show()
...
# plt.axis([-0.01,0.15,-100,0])
plt.ylim(-100,0)
plt.savefig('autumn_lowLatKPP/GOTM_kpp_kpploc_kppLa_kppheat_kppheatg_5_15_keps_heat_diffusivity_profile.png')
plt.show()
exit()
