...
# print('Glider depth', GldrDepth.values) 482:554
print('Glider time', new_time.shape)
print('Glider fixed time :', new_time[195:1113])
# temperature
# print('Glider temp for time=294', GldrTemp[195,:].values, len(GldrTemp[192,:]))
Gldrtemp294 = GldrTemp[195,:].values
t_profile294 = np.c_[GldrDepth,GldrTemp[195,:].values]
# print('Glider temp for time=294', t_profile294)
# salinity
# print('Glider salt for time=294', GldrSalt[192,:].values, len(GldrSalt[192,:]))
Gldrtemp294 = GldrSalt[195,:].values
s_profile294 = np.c_[GldrDepth,GldrSalt[195,:].values]
# print('Glider salt for time=294', s_profile294)
### ----------------------------- GOTM ----------------------------- ###


gotmkpp = xr.open_dataset("lowhL_KPP294/OSMOSIS_glider_comparison.nc", decode_times=False)
gotmkeps = xr.open_dataset("lowhL_KPP294/OSMOSIS_glider_keps.nc", decode_times=False)
...
time2 = 294.0 + (time[:]/86400); ketime2 = 294.0 + (ketime[:]/86400)
...
# a = [482,491,500,509,518,527,536,545,554]
...
# plt.savefig('osmosis_spring_variablePlots/Glider_Temp_profile_lowhL.png')
# plt.show()

# ## -------------------------- KPP -------------------------- ##
#choose the indices for each day
# b = np.arange(0,1115,100)
# b = [0,143,287,431,575,719,863,1007]
...
# plt.savefig('osmosis_spring_variablePlots/GOTM_kpp_Temp_profile_lowhL.png')
# plt.show()
...
# 	plt.axis([11.5,15.5,-150,0])
# plt.savefig('osmosis_spring_variablePlots/GOTM_keps_Temp_profile_lowhL.png')
# plt.show()
...
GTM_sel = [0] # range [f:m:l] = [0:434:1007] # 590
Gldr_sel = [482] # range [f:m:l] = [483:513:551] # 3130
...
for j in Gldr_sel:
	...
	# plt.ylim(-150,0)
plt.savefig('lowhL_KPP294/Gldr_GOTM_Temperature_profile_lowhL.png')
plt.show()
...
plt.ylim(-150,0)
plt.savefig('lowhL_KPP294/GOTM_eddy_viscosity_profile_lowhL.png')
plt.show()
...
# plt.axis([-0.01,0.15,-150,0])
plt.ylim(-150,0)
plt.savefig('lowhL_KPP294/GOTM_heat_diffusivity_profile_lowhL.png')
plt.show()
...
# plt.axis([-0.01,0.15,-150,0])
plt.ylim(-150,0)
plt.savefig('lowhL_KPP294/GOTM_streamwise_velocity_profile_lowhL.png')
plt.show()
